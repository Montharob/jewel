<template>
    <div class="container">
      ...
      -->
          ...
          <button @click="buyProduct()" style="color: black; background: grey; margin-bottom:10px;">สั่งซื้อ</button>
        </div>
      </div>
    </div>
   ...
   <!-- <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3" v-for="(product, index) in product" :key="index">
          <div class="li">
            <img :src="product.picture" class="card-img-top" ref="imageURL" />
            <div class="card-body">
              <h5 class="card-title">{{ product.name }}</h5>
              <hr />
              <h6 class="card-title">ราคา : {{ product.price }}</h6>
              <hr />
            </div>
            ...
            <div v-show="product.isvisible">
              <div class="box">
                <div class="boxShow">
                  <img :src="product.picture" class="" ref="imageURL" />
  ...
  */
  ...
  header {
    ...
    padding: 0.25rem;
    background-color: rgba(121, 115, 115, 0.723);
    color: #fff;
    text-align: center;
  ...
  .cart-content {
    box-shadow: 0 2px 8px rgb(116, 114, 8); 
  ...
  .buy-button {
    background: rgb(153, 158, 158);
    border-color: rgb(8, 23, 28);
  }
